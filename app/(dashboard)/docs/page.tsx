    ...
    <>
      ...
      <div className="docs-layout">
        ...
        <Section
          ...
          summary="Seven steps, and two of them can stop it."
        >
        ...
        >
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <DefinitionCard
              title="Email"
              badge="verified"
              body="A personal inbox. MailPiston forwards a notification there, and you can reply from it — the reply returns through a relay address, so your personal address never appears in customer headers."
              detail="The address must prove control first: MailPiston sends a challenge and will not forward anything until it is answered. A typo must not start mail flowing to a stranger."
            />
          </div>
...
const PIPELINE = [
  {
    ...
    body: 'Forward Email POSTs the message to this deployment, signed with the domain’s webhook key. An unsigned or wrongly signed request is refused before anything is spent on it.',
  },
  {
  ...
  {
    title: 'Attachments and raw MIME are stored',
    body: 'Bytes go to object storage before the database row is written, so the worst case is an orphaned object rather than a row pointing at bytes that do not exist.',
  },
  {
